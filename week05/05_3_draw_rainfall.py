...
def main():
    ...
    for chromosome in tqdm.tqdm(chromosome_list):
        ...
        seaborn.scatterplot(data=chromosome_data, x="POS", y="Dis", hue="Mut", style="Mut", hue_order=list(coloring.keys()), palette=coloring, legend="full", edgecolor=None, s=1000, ax=ax)
