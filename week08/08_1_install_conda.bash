...
"${HOME}/miniconda3/bin/conda" create --channel conda-forge --channel bioconda --prefix "$(realpath .)/conda" --yes
"${HOME}/miniconda3/bin/conda" install --channel conda-forge --channel bioconda bioconductor-purecn=2.12.0 --prefix "$(realpath .)/conda" --yes
